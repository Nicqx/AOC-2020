import Days.Day1, Days.Day2, Days.Day3, Days.Day4, Days.Day5, Days.Day6, Days.Day7, Days.Day8
...
arr = read_to_array_string("Days/Source/day7.txt")
print("Day7/1: " + str(Days.Day7.part1(arr)))
print("Day7/2: " + str(Days.Day7.part2(arr)))

arr = read_to_array_string("Days/Source/day8.txt")
print("Day8/1: " + str(Days.Day8.part1(arr)))
print("Day8/2: " + str(Days.Day8.part2(arr)))
